...
<div class="advisory-areas">
  <section class="advisory-area advisory-area-primary" id="ai-innovation">
    <header>
    ...
    <div class="advisory-area-body">
      <div class="advisory-questions">
        <h3>Typical work</h3>
        <ul>
          <li>Architecture and technical direction</li>
          <li>Roadmaps and product decisions</li>
          <li>Independent review of plans and risks</li>
          <li>Prototype-to-product strategy</li>
          <li>Build, buy or partner decisions</li>
        </ul>
      </div>
      <div class="advisory-formats">
        <article>
          <p class="micro-label">Focused format</p>
          <h3>Technical Decision Session</h3>
          <p>A focused 90-minute working session, with limited pre-read and concise written recommendations.</p>
        </article>
        <article>
          <p class="micro-label">Defined review</p>
          <h3>AI &amp; Software Direction Review</h3>
          <p>A structured 7 to 10 day review, ending in a decision memo and executive discussion.</p>
        </article>
      </div>
    </div>
    <a class="button button-light js-contact-open" data-contact-topic="engagement" data-contact-interest="AI &amp; Innovation Advisory" href="/contact/?topic=engagement&amp;interest=AI%20%26%20Innovation%20Advisory">Discuss AI &amp; Innovation Advisory <span>↗</span></a>
  </section>

  <section class="advisory-area" id="rd-leadership">
    <header>
    ...
    <div class="advisory-area-body">
      <div class="advisory-questions">
        ...
        <ul>
          ...
          <li>Scientific and technical direction</li>
        </ul>
      </div>
      <div class="advisory-formats">
        <article>
        ...
        <article>
          ...
          <h3>Scientific &amp; Technical Advisor</h3>
          <p>Reserved monthly capacity for reviews, roadmap decisions, team guidance and mentoring.</p>
        </article>
      </div>
    </div>
    <a class="button button-dark js-contact-open" data-contact-topic="engagement" data-contact-interest="R&amp;D Strategy &amp; Scientific Leadership" href="/contact/?topic=engagement&amp;interest=R%26D%20Strategy%20%26%20Scientific%20Leadership">Discuss R&amp;D and scientific leadership <span>↗</span></a>
  </section>
</div>
...
<div class="fees-panel">
  ...
  <div class="fee-steps">
    ...
    <p><strong>Reviews and sprints</strong><br>Fixed scope and fee, agreed once the inputs and boundaries are clear.</p>
    <p><strong>Ongoing advisory</strong><br>A monthly retainer for reserved capacity and agreed responsibilities.</p>
    <p><strong>Delivery</strong><br>Based in Luxembourg and working internationally, primarily remotely. In-person work can be arranged separately.</p>
  </div>
</div>
